...
from game.logic.botLogic import botLogic
from game.logic.DanielBot import DanielBot
from game.logic.MattBot import MattBot
init()
BASE_URL = "http://localhost:3000/api"
DEFAULT_BOARD_ID = 1
CONTROLLERS = {
    "Random": RandomLogic, "Logic": botLogic, "Daniel":DanielBot, "Matthew":MattBot,
}
